#' Retrieve the available baseball games for a given league, team and season during a specific time interval.
#' 
#' A function to retrieve all of the available baseball games for a specified team.
#' 
...
#' 
#' @return a dataframe of the baseball games for the specified league.
#' 
#' @examples 
#' \dontrun{
#' set_token("insert-your-token-here")
#' results <- baseball_games(league="mlb", team_id="mlb-bos")
#' }
#' @export
#' baseball_games

baseball_games <- function(league = "mlb", 
                           team_id = "mlb-bos", 
